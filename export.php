...
/*
 * this file is identical to the standard /wp-admin/export.php
 * with the following exceptions:
 *
 * 1. we have to muck with $_SERVER['PHP_SELF'] while loading
 ...
 * 2. the @id's on the "Posts" and "Pages" export filter <ul>'s and
 *    the Javascript output to expand/collapse the export filters
 *    is generalized so that custom export filters added by plugins
 *    hooking into 'export_filters' will actually work
 * 3. the page title :-)
 */
